 ...
 * SR       0b11  2 byte:  byte1=data  (SR_MASK_PC_SPARE bitlerine uygulanir,
 *                          bkz. app_config.h)
 *
 * Opcode -> handler eslesmesi pc_control.c'deki s_commands[] tablosunda;
 * PC_CMD_COUNT tabloyla ayni sirada olmalidir (OP_* degerleri = tablo indeksi).
 */
